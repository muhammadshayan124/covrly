    ...
    <div className="flex flex-1 bg-black">
      <div className="flex w-full flex-col items-center justify-center px-6 py-16 lg:w-1/2">
        ...
        >
          ...
          <h1 className="mt-8 text-2xl font-semibold text-white">Set up your business</h1>
          <p className="mt-1 text-sm text-white/50">Free trial, no card required.</p>
      ...
      <div className="relative hidden w-1/2 items-center justify-center overflow-hidden border-l border-white/10 bg-white/[0.02] lg:flex">
        ...
        <div className="pointer-events-none absolute -top-24 right-0 h-96 w-96 rounded-full bg-violet-600/20 blur-[100px] animate-blob" />
        <motion.div
